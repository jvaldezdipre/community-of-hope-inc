-- ============================================================================
-- Round 6 (final): Add FAQ + Bottom CTA blocks. Hope House fully CMS-managed.
-- ============================================================================
-- Paste into Supabase → SQL Editor → New query → Run.
--
-- Full replace of hope-house row with all 9 blocks seeded.
-- ============================================================================
...
values (
  ...
  '{
    "content": [
      ...
      {
        "type": "HopeHouseFAQBlock",
        "props": {
          "id": "HopeHouseFAQBlock-main",
          "heading": "Common Questions",
          "faqs": [
            {
              "question": "How quickly can someone move in?",
              "answer": "Accommodation is based on bed availability, with crisis cases prioritized. You''ll hear back from us regarding your application. Call us directly at 860-912-4356 to discuss your situation. For immediate resources anywhere in Connecticut, you can also dial 2-1-1 or visit 211ct.org anytime.",
              "helpfulLinks": [
            ...
            },
            {
              ...
              "answer": "Hope House is faith-based and rooted in Christian values. However, we welcome women of all backgrounds and beliefs. Our faith approach is about love, community, and second chances, not requirements or judgment.",
              "helpfulLinks": []
            },
            {
              "question": "What does the program include?",
              "answer": "Residents receive safe housing, mentoring, job readiness support, clothing with dignity, leadership opportunities, community activities, and ongoing personal support. Everything is designed to help women transition from crisis to independence.",
              "helpfulLinks": []
            },
            {
              "question": "How long does someone stay at Hope House?",
              "answer": "Program length varies based on individual needs, typically ranging from 6 to 18 months. We don''t rush anyone out. The goal is lasting transformation, not a quick fix.",
              "helpfulLinks": []
            },
            {
              "question": "Is there a cost for residents?",
              "answer": "There is no cost for residents. As a nonprofit, we believe every woman who needs help should have access to it, regardless of financial situation.",
              "helpfulLinks": []
            }
          ]
        }
      ...
      {
        "type": "HopeHouseBottomCTABlock",
        "props": {
          "id": "HopeHouseBottomCTABlock-main",
          "heading": "Ready to take the next step?",
          "description": "Whether you''re seeking help for yourself, referring a client, or reaching out for a loved one, we''re here. No judgment, just a conversation.",
          "buttonLabel": "Apply Now",
          "buttonHref": "/apply-hope-house",
          "phoneNumber": "860-912-4356"
        }
