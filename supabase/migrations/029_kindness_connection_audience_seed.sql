-- ============================================================================
-- Round 3b: Add the "Who This Is For" block to the Kindness Connection page.
-- ============================================================================
-- Paste into Supabase → SQL Editor → New query → Run.
--
-- Full replace of the kindness-connection row with hero + receive + details
-- + process + audience blocks seeded. Safe to run if you haven't customized
-- earlier blocks yet. If you HAVE edited them and want to preserve those
-- edits, skip this migration and add the audience block manually in the admin.
-- ============================================================================
