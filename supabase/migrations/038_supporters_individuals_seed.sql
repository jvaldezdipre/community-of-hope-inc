-- ============================================================================
-- Round 4a: Add the Individual Supporters block to the Supporters page.
-- ============================================================================
-- Paste into Supabase → SQL Editor → New query → Run.
--
-- Full replace of the supporters row with hero + featured partnership +
-- corporate + event + gratitude + by-category + individuals blocks seeded.
-- Individuals are text-only (no logo upload) — staff adds one name per row.
-- ============================================================================
