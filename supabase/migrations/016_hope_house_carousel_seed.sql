-- ============================================================================
-- Round 4: Add Photo Carousel block ("Inside Hope House") to the Hope House page.
-- ============================================================================
-- Paste into Supabase → SQL Editor → New query → Run.
--
-- Full replace of hope-house row with hero + receive + details + process +
-- carousel. Photos are seeded from the existing Unsplash placeholders — staff
-- can replace each with real uploaded photos from the editor.
-- ============================================================================
