-- ============================================================================
-- Round 4b: Add the Bottom CTA block to the Supporters page.
-- ============================================================================
-- Paste into Supabase → SQL Editor → New query → Run.
--
-- Final round. Full replace of the supporters row with ALL 8 sections
-- seeded (hero, featured partnership, corporate, event, gratitude, by
-- category, individuals, bottom CTA). After this runs, the entire
-- Supporters page is rendered from CMS content and the hardcoded fallback
-- in SupportersPageContent.tsx is no longer used.
-- ============================================================================
...
values (
  ...
  '{
    "content": [
      ...
      {
        "type": "SupportersIndividualBlock",
        "props": {
          "id": "SupportersIndividualBlock-main",
          ...
          "names": [
            ...
            { "name": "Gingerella \"Jo Jo Nice\"" },
            { "name": "Pat Todd" },
            { "name": "Denise Nott" },
            { "name": "Jennifer Latz" },
            { "name": "Dennis Latz" },
            { "name": "Biddy Barbee" },
            { "name": "Sandy St. Germain" },
            { "name": "Karen Neilan" },
            { "name": "Verna Swan" }
          ]
        }
      ...
      {
        "type": "SupportersBottomCTABlock",
        "props": {
          "id": "SupportersBottomCTABlock-main",
          "eyebrow": "Be Part Of This Story",
          "heading": "Your name could be here.",
          "description": "Every supporter on this page chose to show up for women who needed a hand. You can make that same choice today.",
