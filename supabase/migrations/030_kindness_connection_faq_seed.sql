-- ============================================================================
-- Round 4a: Add the FAQ block to the Kindness Connection page.
-- ============================================================================
-- Paste into Supabase → SQL Editor → New query → Run.
--
-- Full replace of the kindness-connection row with hero + receive + details
-- + process + audience + faq blocks seeded. Safe to run if you haven't
-- customized earlier blocks yet. If you HAVE edited them and want to
-- preserve those edits, skip this migration and add the FAQ block manually
-- in the admin.
-- ============================================================================
