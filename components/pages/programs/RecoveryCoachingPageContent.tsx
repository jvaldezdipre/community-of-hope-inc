...
// Toggle this to true when the full Recovery Coaching program is ready to launch
          ...
          <div className="max-w-[1200px] mx-auto px-6" style={{ paddingTop: "clamp(32px, 4vw, 48px)", paddingBottom: sectionPaddingLg }}>
            <div className="grid md:grid-cols-[1fr_440px] gap-10 md:gap-16 items-center">
              ...
              >
                ...
                >
                  Community of Hope is an approved partner of CCAR (Connecticut
                  Community for Addiction Recovery). We are committed to
                  expanding recovery coaching opportunities as part of our
                ...
                >
                  This program is currently in development. Learn more about
                  CCAR Recovery Coach certification below.
                </p>
                <div className="flex flex-wrap items-center gap-4">
                  <Button
                    variant="primary"
                    as="a"
                    href="https://addictionrecoverytraining.org/ccar-trainings/"
                    target="_blank"
